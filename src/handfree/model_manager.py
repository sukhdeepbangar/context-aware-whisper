...
Usage:
    python -m handfree.model_manager list              # List available models
    python -m handfree.model_manager download base.en  # Download a specific model
    python -m handfree.model_manager info base.en      # Show model info
"""
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="handfree-models",
        description="Manage whisper.cpp models for HandFree local transcription",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  handfree-models list                    List all models and status
  handfree-models download base.en        Download base.en model
  handfree-models download small.en -f    Force re-download
  handfree-models info base.en            Show model details
